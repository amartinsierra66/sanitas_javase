...
public class ManejaCadenas {
	public static void main(String[] args) {
		...
		service.procesarCadenas(textos, c->c.startsWith("a"), c->System.out.println(c));
		//Mostrar las cadenas que tengan más de tres caracteres
		service.procesarCadenas(textos, c->c.length()>3, c->System.out.println(c));
		...
		service.procesarListas(List.copyOf(textos), numeros, (a,b)->a+b, c->System.out.println(c));
